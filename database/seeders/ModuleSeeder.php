...
class ModuleSeeder extends Seeder
{
    protected $data = [
        ...
        ['menu_id'=>1,'type'=>2,'module_name'=>'Setting','divider_title'=>null,'icon_class'=>'fas fa-cogs','url'=>'setting','order'=>7,'parent_id'=>null],
        ['menu_id'=>1,'type'=>2,'module_name'=>'Menu','divider_title'=>null,'icon_class'=>'fas fa-th-list','url'=>'menu','order'=>8,'parent_id'=>null],
