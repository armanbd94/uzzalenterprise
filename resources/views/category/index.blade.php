        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Category')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        table = $('#dataTable').DataTable({
            ...
            "buttons": [
                ...
                },
                {
                    ...
                    'columns': ':gt(0)',
                    "exportOptions": {
                        @if (permission('category-bulk-delete') || permission('product-category-bulk-delete'))
