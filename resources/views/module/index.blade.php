...
@push('styles')
<link href="{{asset('css/jquery.nestable.min.css')}}" rel="stylesheet" type="text/css" />
@endpush
...
<div class="d-flex flex-column-fluid">
    <div class="container-fluid">
        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="{{ route('menu') }}" type="button" class="btn btn-secondary btn-sm font-weight-bolder mr-2"> <i class="fas fa-arrow-circle-left"></i> {{__('file.Back')}}</a>
                    @if (permission('menu-module-add'))
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Module')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <h5 class="card-item">{{__('file.Drag and drop the menu item below to re-arrange them')}}</h5>
            </div>
...
$(document).ready(function(){
    ...
    $(document).on('change','.dd',function(e){
        $.post('{{ route("menu.module.order",["menu"=>$menu->id]) }}',{
            ...
            notification('success','{{__('file.Menu order updated successfully')}}');
            menuItems();
        });
    });
    ...
    $(document).on('click', '.delete_data', function () {
        ...
        Swal.fire({
            title: '{{__('file.Are you sure to delete')}} ' + name + '?',
