        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Module Permission')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="{{__('file.Permission Name')}}" name="name" col="col-md-4" />
                        <x-form.selectbox labelName="{{__('file.Module')}}" name="module_id" required="required" col="col-md-4" class="selectpicker">
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        @endif
                                        <th>{{__('file.SL')}}</th>
                                        <th>{{__('file.Module')}}</th>
                                        <th>{{__('file.Permission Name')}}</th>
                                        <th>{{__('file.Permission Slug')}}</th>
        ...
        if (id) {
            $.ajax({
                ...
                success: function (data) {
                    ...
                    $('#update_modal #update-btn').text('{{__('file.Update')}}');
