            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('role') }}" class="btn btn-secondary btn-sm font-weight-bolder">
                        <i class="fas fa-arrow-circle-left"></i> {{__('file.Back')}}
                    </a>
                    <!--end::Button-->
                </div>
            </div>
                        ...
                        <form id="saveDataForm" method="post">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-md-12 required">
                                    <label for="role_name">{{__('file.Role Name')}}</label>
                                    <input type="text" class="form-control" name="role_name" id="role_name" value="@isset($role){{$role->role_name}}@endisset" placeholder="{{__('file.Role Name')}}">
                                </div>
                                <div class="col-md-12">
                                            ...
                                            @foreach ($permission_modules as $menu)
                                                @if ($menu->submenu->isEmpty())
                                                    <li>
                                                        ...
                                                        {!! $menu->type == 1 ? __('file.'.$menu->divider_title).'<small>('.__('file.Divider').')</small>' : __('file.'.$menu->module_name) !!}
                                ...
                                <div class="col-md-12 pt-4 text-center">
                                    @if(isset($role))
                                    <a href="{{ route('role') }}" class="btn btn-danger btn-sm font-weight-bolder">{{__('file.Cancel')}}</a>
                                    @else
                                    <button type="reset" class="btn btn-danger btn-sm">{{__('file.Reset')}}</button>
                                    @endif
                                    <button type="button" class="btn btn-primary btn-sm" id="save-btn">@if(isset($role)) {{ __('file.Update') }} @else {{ __('file.Save') }} @endif</button>
                                </div>
                            </div>
                        </form>
                    </div>
