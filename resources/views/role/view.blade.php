    ...
    <div class="container-fluid">
        ...
        <div class="card card-custom">
            <div class="card-header pt-5 text-center">
                <h5 class="text-center w-100 m-0">{{ $role->role_name }} {{__('file.Role Details')}}</h5>
            </div>
            <div class="card-body">
                <div class="row">
                    <div class="col-sm-12">
                                ...
                                @foreach ($permission_modules as $menu)
                                    @if ($menu->submenu->isEmpty())
                                        <li class="@if($menu->type == 2) {{ 'mb-5' }} @endif">
                                            ...
                                            @endif
                                            <b>{!! $menu->type == 1 ?  __('file.'.$menu->divider_title).'<small>('.__('file.Divider').')</small>' : __('file.'.$menu->module_name) !!}</b>
