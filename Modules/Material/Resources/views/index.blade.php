        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showNewFormModal('{{__('file.Add New Material')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="{{__('file.Material Name')}}" name="material_name" col="col-md-3" />
                        <x-form.textbox labelName="{{__('file.Material Code')}}" name="material_code" col="col-md-3" />
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Purchase Unit')}}</th>
                                        <th>{{__('file.Stock Qty')}}</th>
                                        <th>{{__('file.Alert Qty')}}</th>
                                        <th>{{__('file.Tax Rate')}}(%)</th>
                ...
                $.ajax({
                    ...
                    success: function (data) {
                        if(data.status == 'error'){
                            ...
                            let edit = '{{__('file.Edit')}}';
                            let update = '{{__('file.Update')}}';
                            console.log(data);
                            $('#store_or_update_modal .modal-title').html(
                                '<i class="fas fa-edit text-white"></i> <span>' + edit + ' ' + data.material_name + '</span>');
