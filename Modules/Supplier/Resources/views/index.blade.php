        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Supplier')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.textbox labelName="{{__('file.Email')}}" name="email" col="col-md-3" />
                        <x-form.selectbox labelName="{{__('file.Supplier Type')}}" name="type" col="col-md-3" class="selectpicker">
