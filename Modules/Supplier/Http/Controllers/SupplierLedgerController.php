...
class SupplierLedgerController extends BaseController
{
    ...
    public function index()
    {
        if(permission('supplier-ledger-access')){
            ...
            $setSubTitle = __('file.Supplier Ledger');
            $this->setPageData($setSubTitle,$setSubTitle,'fas fa-file-invoice-dollar',[['name'=>$setTitle,'link'=>route('supplier')],['name'=>$setSubTitle]]);
