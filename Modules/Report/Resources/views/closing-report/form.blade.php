                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="card card-custom card-border">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label">{{__('file.Closing Account')}} </h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="last_day_closing">{{__('file.Last Day Closing')}}</label>
                                            <input type="text" class="form-control" name="last_day_closing" id="last_day_closing"  readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="cash_in">{{__('file.Receive')}}</label>
                                            <input type="text" class="form-control" name="cash_in" id="cash_in" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="cash_out">{{__('file.Payment')}}</label>
                                            <input type="text" class="form-control" name="cash_out" id="cash_out" readonly>
                                        </div>
                                        <div class="form-group">
                                            <label for="cash_in_hand">{{__('file.Balance')}}</label>
                                            <input type="text" class="form-control" name="cash_in_hand" id="cash_in_hand" readonly>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="card card-custom card-border">
                                    <div class="card-header">
                                        <div class="card-title">
                                            <h3 class="card-label">{{__('file.Cash In Hand')}}</h3>
                                        </div>
                                    </div>
                                    <div class="card-body">
                                        <table class="table table-bordered table-hover">
                                            <thead class="bg-primary">
                                                <tr>
                                                    <th class="text-center">{{__('file.Note Name')}}</th>
                                                    <th class="text-center">{{__('file.Pcs')}}</th>
                                                    <th class="text-center">{{__('file.Amount')}}</th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <tr>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    <td colspan="2" class="text-right"><b>{{__('file.Grand Total')}}</b></td>
