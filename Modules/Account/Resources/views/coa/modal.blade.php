          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="{{__('file.Head Level')}}" name="level" required="required" col="col-md-12"/>
                    ...
                    <div class="form-group col-md-12 d-flex justify-content-between">
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="transaction">{{__('file.Is Transaction')}}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            ...
                            <label class="custom-control-label" for="general_ledger">{{__('file.Is General Ledger')}}</label>
                        </div>
                        <div class="custom-control custom-checkbox">
                            <input type="checkbox" class="custom-control-input" name="status" id="status" value="1" checked onchange="set_checkbox_value('status')">
                            <label class="custom-control-label" for="status">{{__('file.Is Active')}}</label>
                        </div>
                    </div>
