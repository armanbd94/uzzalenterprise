                                ...
                                <div class="col-md-12">
                                    <table class="table table-bordered" id="debit-voucher-table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <select name="contra_account[1][id]" id="contra_account_1_id" class="form-control selectpicker">
                                                ...
                                                <td>
                                                    <input type="text" class="form-control text-right debit_amount" onkeyup="calculate_total(1)" name="contra_account[1][debit_amount]" id="contra_account_1_debit_amount" placeholder="0.00">
                                                </td>
                                                <td>
                                                    <input type="text" class="form-control text-right credit_amount" onkeyup="calculate_total(2)" name="contra_account[1][credit_amount]" id="contra_account_1_credit_amount" placeholder="0.00">
                                                </td>
                                                <td></td>
                                            </tr>
                                        </tbody>
                                        <tfoot>
                                            <tr>
                                                ...
                                                <td class="text-center"><button type="button" class="btn btn-primary btn-sm" id="add_more_account" data-toggle="tooltip" data-placement="top" data-original-title="Add More"><i class="fas fa-plus-square"></i></button>
                                                </td>
                                            </tr>
                                        </tfoot>
                                    </table>
