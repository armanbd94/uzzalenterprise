            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row justify-content-center">
                        ...
                        <x-form.selectbox labelName="{{__('file.Bank')}}" name="bank_acc_id"  col="col-md-3" class="selectpicker">
                            @if (!$banks->isEmpty())
            ...
            <div class="card-body">
                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <div id="report" style="width: 100%;margin:0;padding:0;">
                        ...
                        <h4 class="text-dark text-center py-3"><b> ({{__('file.From')}} {{__('file.To')}})</b></h4>
                        <table class="table table-borderless" style="width:100%;">
                            <thead class="bg-primary">
                                <tr>
                                    <th class="text-right">{{__('file.Opening Balance')}}: {{ number_format(0,2) }}</th>
                                </tr>
                            </thead>
                        </table>
                        <table class="table table-bordered" style="width:100%;">
                            <thead class="bg-primary">
                                <tr>
                                    ...
                                    <th class="text-center">{{__('file.Voucher No')}}.</th>
                                    <th class="text-center">{{__('file.Voucher Type')}}</th>
                                    <th class="text-left">{{__('file.Remarks')}}</th>
                            ...
                            <tfoot>
                                <tr class="bg-primary">
                                    <td colspan="5" class="text-right text-white font-weight-bolder">{{__('file.Total')}}</td>
...
if(bank_acc_id){
    ...
    notification('error','{{__('file.Please select a bank')}}');
}
