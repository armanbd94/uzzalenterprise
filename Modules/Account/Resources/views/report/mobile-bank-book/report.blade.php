...
<h4 class="text-dark text-center py-3"><b> {{ $bank_name }} (From {{ date('d-M-Y',strtotime($start_date)) }} To {{ date('d-M-Y',strtotime($end_date)) }})</b></h4>
<table class="table table-borderless" style="width:100%;">
    <thead class="bg-primary">
        <tr>
            <th class="text-right">{{__('file.Opening Balance')}}: {{ number_format($previous_balance,2) }}</th>
        </tr>
    </thead>
</table>
