            ...
            <div id="printArea">
                <div class="panel-body">
                  ...
                  <table class="table" width="100%" class="table_boxnew" cellpadding="5" cellspacing="0">
                    <tr>
                        <td colspan="2" align="center"><h3><b>{{__('file.Statement of Comprehensive Income')}}<br/>From <?php echo $start_date ?> To <?php echo $end_date;?></b></h3></td>
                    </tr>
                    <tr>
                      <td width="85%" align="center"><h4><b>{{__('file.Particulars')}}</b></h4></td>
                      <td width="15%" align="center"><h4><b>{{__('file.Amount')}}</b></h4></td>
                    </tr>
                    <?php
                    for($i=0;$i<count($asset_accounts);$i++)
                    {
                    ...
                    ?>
                    <tr>
                        <td align="right"><strong>{{__('file.Total Income')}}</strong></td>
                    ...
                    ?>
                    <tr >
                        <td align="right"><strong>{{__('file.Total Expense')}}</strong></td>
                    ...
                    <tr class="profitloss-result">
                        <td align="right" style="background: #036;color:white;"><h4>{{__('file.Profit-Loss')}} <?php echo $TotalAssetF>$TotalLibilityF ? '(' .__('file.Profit') . ')' : '(' .__('file.Loss') . ')' ;?></h4></td>
