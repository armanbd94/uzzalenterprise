                ...
                <div class="panel-body">
                    <div>
                        ...
                        <table width="100%" class="table_boxnew" style="padding: 5px">
                            <tr>
                                <td colspan="3" align="center">
                                    <h4 style="margin: 0;">{{__('file.Cash Flow Statement')}} </h4>
                                </td>
                            </tr>
                            <tr class="table_head">
                                <td colspan="3" align="center" style="padding-left:10px"><b>{{__('file.From')}} {{ $start_date }} {{__('file.To')}} {{ $end_date }}</b></td>
                            </tr>
                            <tr class="table_head">
                                <td width="73%" height="29" align="center"
                                    style="padding-left:10px; border:1px solid #000;">
                                    <b>{{__('file.Particulars')}}</b></td>
                                <td width="2%">&nbsp;</td>
                                <td width="30%" align="right"
                                    style="padding-left:10px; padding-right:10px;  border:1px solid #000;;">
                                    <b>{{__('file.Amount')}}</b></td>
                            </tr>
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px">
                                    <strong>{{__('file.Opening Cash and Equivalent')}}:</strong></td>
                            </tr>
                            <?php
                      ...
                      ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Total Opening Cash & Cash Equivalent')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                            ...
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>{{__('file.Cash Flow From Operating Activities')}}</b></td>
                            </tr>
                            <?php
                          $TotalCurrAsset=0;
                      ...
                      if($oResultAmount->amount!=0)
                      {
                        ?>
                            <tr>
                                <td align="left" style="padding-left:10px">{{__('file.Payment for Other Operating Activities')}}</td>
                                <td>&nbsp;</td>
                                <td align="right"
                    ...
                    ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Cash generated from Operating Activities before Changing in Operating Assets & Liabilities')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>{{__('file.Cash Flow from Non-Operating Activities')}}</b></td>
                            </tr>
                            <?php
                        $TotalCurrAssetNon=0;
                        $oResultCurrAsset = DB::table('chart_of_accounts')
                      ...
                      ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Cash generated from Non-Operating Activities before Changing in Operating Assets & Liabilities')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <tr class="table_head">
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Increase/Decrease in Operating Assets & Liabilities')}}</strong></td>
                                <td>&nbsp;</td>
                    ...
                    if($oResultAmount->amount!=0)
                    {
                      ...
                      ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Total Increase/Decrease')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Net Cash From Operating/Non-Operating Activities')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px;text-decoration:underline"><b>{{__('file.Cash Flow from Investing Activities')}}</b></td>
                            </tr>
                            <?php
                      $TotalNonCurrAsset=0;
                      ...
                      ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Net Cash Used Investing Activities')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top:solid 1px #000; border-bottom: solid 1px #000;">
                            ...
                            <tr class="table_head"><td colspan="3" style="padding-left:10px;text-decoration:underline"><b>{{__('file.Cash Flow from Financing Activities')}}</b></td></tr>
                            <?php
                      $TotalNonCurrLiab=0;
                      ...
                      ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Net Cash Used Financing Activities')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top:solid 1px #000; border-bottom:solid 1px #000;">
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;"><strong>{{__('file.Net Cash Inflow/Outflow (Profit Loss')}}
                            ...
                            <tr class="table_head">
                                <td colspan="3" style="padding-left:10px"><strong>{{__('file.Closing Cash & Cash Equivalent')}}:</strong></td>
                            </tr>
                            <?php
                    ...
                    ?>
                            ...
                            <tr>
                                <td align="left" style="padding-left:10px;padding-right:10px"><strong>{{__('file.Total Closing Cash & Cash Equivalent')}}</strong></td>
                                <td>&nbsp;</td>
                                <td align="right"
                                    style="padding-right:10px; border-top: solid 1px #000; border-bottom: solid 1px #000;">
                          ...
                          <tr>
                              <td class="text-center">
                                  <div class="font-size-10" style="width:250px;float:left;">
                                      ...
                                      <p style="margin:0;padding:0;">{{__('file.Prepared By')}}</p>
                                  </div>
                              </td>
                              <td class="text-center">
                                  <div class="font-size-10" style="width:250px;margin:0 auto;">
                                      ...
                                      <p style="width:180px;height:2px;margin:0 auto;padding:0;border-top:1px dashed #454d55 !important;"></p>
                                      <p style="margin:0;padding:0;">{{__('file.Accounts')}}</p>
                                  </div>
                              </td>
                              <td class="text-center">
                                  <div class="font-size-10" style="width:250px;float:right;">
                                      <p style="margin:35px 0 0 0;padding:0;"><b class="text-uppercase"></b></p>
                                      <p style="width:180px;height:2px;margin:0 auto;padding:0;border-top:1px dashed #454d55 !important;"></p>
                                      <p style="margin:0;padding:0;">{{__('file.Authorizer')}}</p>
                                  </div>
                              </td>
                          </tr>
                      </table>
