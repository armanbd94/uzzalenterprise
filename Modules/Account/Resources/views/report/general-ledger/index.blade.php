            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row justify-content-center">
                        ...
                        <x-form.selectbox labelName="{{__('file.General Head')}}" name="general_head"  col="col-md-3" class="selectpicker">
                        ...
                        <x-form.selectbox labelName="{{__('file.Transaction Head')}}" name="transaction_head"  col="col-md-3" class="selectpicker"/>
                    ...
                    <div id="report" style="width: 100%;margin:0;padding:0;">
                        ...
                        <table class="table table-borderless" style="width:100%;">
                            <thead class="bg-primary">
                                <tr>
                                    <th class="text-right">{{__('file.Pre Balance')}}: {{ number_format(0,2) }}</th>
                                </tr>
                                <tr>
                                    <th class="text-right">{{__('file.Current Balance')}}: {{ number_format(0,2) }}</th>
                                </tr>
                            </thead>
                        </table>
...
function report()
{
    ...
    if(transaction_head){
        ...
        notification('error','{{__('file.Please select a transaction head')}}');
    }
