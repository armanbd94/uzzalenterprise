                            ...
                            <div class="card-body">
                                <div id="printableArea" style="width: 100%;margin:0;padding:0;">
                                    ...
                                    <table class="table table-borderless" style="width:100%;" id="invoice-table" border="0">
                                        ...
                                        <tr>
                                            <td width="25%"><b>{{__('file.Name')}}</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ $data->coa->supplier->name }}</td>
                                        </tr>
                                        <tr>
                                            <td width="25%"><b>{{__('file.Payment Type')}}</b></td width="5%"><td><b>:</b></td><td width="70%" class="text-left">{{ PAYMENT_METHOD[$payment_type] }}</td>
                                        </tr>
                                        <tr>
                                            <td width="25%"><b>{{__('file.Amount')}}</b></td><td width="5%"><b>:</b></td><td width="70%" class="text-left">{{ number_format($data->debit,2,'.',',') }}Tk</td>
                                        </tr>
                                        <tr>
