        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('supplier.payment.create') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="{{__('file.Supplier')}}" name="supplier_coa_id"  col="col-md-3" class="selectpicker">
                            @if (!$suppliers->isEmpty())
                                @foreach ($suppliers as $supplier)
                                    <option value="{{ $supplier->coa->id }}">{{ $supplier->trade_name.' - '.$supplier->name }}</option>
                                @endforeach
                            @endif
                        </x-form.selectbox>
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Supplier')}}</th>
                                        <th>{{__('file.Account Head')}}</th>  
                                        <th>{{__('file.Remarks')}}</th>
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.supplier_coa_id = $("#form-filter #supplier_coa_id").val();
                data._token        = _token;
            }
        },
        "columnDefs": [
