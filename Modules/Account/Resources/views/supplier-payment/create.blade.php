                    ...
                    <form id="supplier-payment-form" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <x-form.textarea labelName="{{__('file.Remarks')}}" name="remarks" col="col-md-6"/>
...
function store_data(){
    ...
    let url = "{{url('supplier-payment/store')}}";
    $.ajax({
        url: url,
        type: "POST",
        data: formData,
        ...
        success: function (data) {
            ...
            if (data.status == false) {
                ...
                if (data.status == 'success' && data.supplier_transaction != '') {
                    ...
                    window.location.replace("{{ url('supplier-payment/show') }}/"+data.supplier_transaction+'/'+$('#payment_type option:selected').val());
