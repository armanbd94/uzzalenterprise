        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('customer.receive.create') }}"  class="btn btn-primary btn-sm font-weight-bolder custom-btn"> 
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        ...
                        <x-form.selectbox labelName="{{__('file.Customer')}}" name="customer_coa_id" required="required"  col="col-md-3" class="selectpicker">
    ...
    table = $('#dataTable').DataTable({
        ...
        "ajax": {
            ...
            "data": function (data) {
                ...
                data.customer_coa_id = $("#form-filter #customer_coa_id").val();
                data._token        = _token;
            }
        },
        "columnDefs": [
