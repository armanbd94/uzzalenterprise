          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                  ...
                  <x-form.selectbox labelName="{{__('file.Expense Type')}}" name="expense_item_id" col="col-md-12" required="required" class="selectpicker">
                  ...
                  <x-form.selectbox labelName="{{__('file.Payment Type')}}" name="payment_type" required="required" onchange="account_list(this.value)"  col="col-md-12" class="selectpicker">
                  ...
                  <div class="form-group col-md-12">
                    <label for="remarks">{{__('file.Remarks')}}</label>
