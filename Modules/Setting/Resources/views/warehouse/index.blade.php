        ...
        <div class="card card-custom gutter-b">
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="javascript:void(0);" onclick="showFormModal('{{__('file.Add New Warehouse')}}','{{__('file.Save')}}')" class="btn btn-primary btn-sm font-weight-bolder">
