                                    ...
                                    <tbody>
                                        @if (isset($purchase_data))
                                            ...
                                            <tr>
                                                ...
                                                <td><input type="text" class="net_unit_cost form-control text-right" id="materials_{{ $key+1 }}_net_unit_cost" name="materials[{{ $key+1 }}][net_unit_cost]" value="{{ $item['net_unit_cost'] }}"></td>
