                ...
                <div id="kt_datatable_wrapper" class="dataTables_wrapper dt-bootstrap4 no-footer">
                    <form action="" id="purchase_store_form" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <x-form.textbox labelName="{{__('file.Purchase Date')}}" name="purchase_date" value="{{ date('Y-m-d') }}" required="required" class="date" col="col-md-3"/>
...
function calculateRowTotal(row)
{
    ...
    $(`#products_${row}_subtotal`).val((qty * cost).toFixed(2));
...
function calculateNetTotal()
{
    ...
    var grand_total = total_cost + shipping_cost;
