                            ...
                            <div>
                                    ...
                                    <tr>
                                        <td width="50%">
                                            <div class="invoice-to">
                                                <div class="text-grey-light"><b>{{__('file.BILLING TO')}}</b></div>
                                        ...
                                        <td width="50%" class="text-right">
                                            ...
                                            <div class="m-0 date"><b>{{__('file.Status')}}:</b>{{ $purchase->purchase_status ? PURCHASE_STATUS[$purchase->purchase_status] : 'N/A' }}</div>
                                        </td>
                                    </tr>
                                </table>
                                <table border="0" cellspacing="0" cellpadding="0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2"  class="text-right">{{__('file.TOTAL')}}</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"  class="text-right">{{__('file.DISCOUNT')}}</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                        ...
                                        <tr>
                                            ...
                                            <td colspan="2"  class="text-right">{{__('file.TAX')}} {{ $purchase->order_tax_rate }}%</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                        ...
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2"  class="text-right">{{__('file.SHIPPING COST')}}</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                        ...
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2"  class="text-right">{{__('file.GRAND TOTAL')}}</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
                                        ...
                                        <tr>
                                            <td colspan="4"></td>
                                            <td colspan="2"  class="text-right">{{__('file.PAID AMOUNT')}}</td>
                                            <td class="text-right">
                                                @if (config('settings.currency_position') == 2)
