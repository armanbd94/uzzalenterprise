          ...
          @csrf
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <x-form.textbox labelName="{{__('file.Paid Amount')}}" name="amount" required="required" col="col-md-12"/>
                    ...
                    <x-form.textarea labelName="{{__('file.Payment Note')}}" name="payment_note" col="col-md-12"/>
                </div>
            </div>
            <!-- /modal body -->
            ...
            <button type="button" class="btn btn-primary btn-sm" id="payment-save-btn">{{__('file.Save')}}</button>
            </div>
            <!-- /modal footer -->
        </form>
      </div>
