        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row">
                        <x-form.textbox labelName="{{__('file.Company Name')}}" name="company_name" col="col-md-3" />
                        <x-form.textbox labelName="{{__('file.Customer Name')}}" name="name" col="col-md-3" />
                        <x-form.textbox labelName="{{__('file.Mobile')}}" name="mobile" col="col-md-3" />

                        <x-form.selectbox labelName="{{__('file.Customer Group')}}" name="customer_group_id" col="col-md-3" class="selectpicker">
                            ...
                            <table id="dataTable" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Mobile No')}}.</th>
                                        <th>{{__('file.Group Name')}}</th>
                                        <th>{{__('file.Email')}}</th>
                                        <th>{{__('file.City')}}</th>
                                        <th>{{__('file.Zipcode')}}</th>
