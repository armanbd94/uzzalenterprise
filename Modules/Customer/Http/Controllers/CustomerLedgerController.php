...
class CustomerLedgerController extends BaseController
{
    ...
    public function index()
    {
        if(permission('customer-ledger-access')){
            ...
            $setSubTitle = __('file.Customer Ledger');
            $this->setPageData($setSubTitle,$setSubTitle,'fas fa-file-invoice-dollar',[['name'=>$setTitle,'link'=>route('customer')],['name'=>$setSubTitle]]);
