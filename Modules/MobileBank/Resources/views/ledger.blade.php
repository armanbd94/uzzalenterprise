            ...
            <div class="card-header flex-wrap py-5">
                ...
                <div class="card-toolbar">
                    ...
                    <a href="{{ route('mobilebank') }}" class="btn btn-primary btn-sm font-weight-bolder ml-3">
                        <i class="fas fa-university"></i> {{__('file.Manage Mobile Bank')}}</a>
                    @endif
                    ...
                    <a href="{{ route('mobilebank.transaction') }}" class="btn btn-primary btn-sm font-weight-bolder ml-3">
                        <i class="far fa-money-bill-alt"></i> {{__('file.Mobile Bank Transaction')}}</a>
                    @endif
                    <!--end::Button-->
                </div>
            </div>
            ...
            <div class="card-header flex-wrap py-5">
                <form method="POST" id="form-filter" class="col-md-12 px-0">
                    <div class="row justify-content-center">
                        ...
                        <x-form.selectbox labelName="{{__('file.Mobile Bank Name')}}" name="bank_name" required="required" col="col-md-3" class="selectpicker">
                            @if (!$banks->isEmpty())
                            ...
                            <table id="bank-ledger-table" class="table table-bordered table-hover">
                                <thead class="bg-primary">
                                    <tr>
                                        ...
                                        <th>{{__('file.Withdraw / Deposit ID')}}</th>
...
$(document).ready(function(){
    ...
    $(document).on('click','#btn-filter',function(){
        ...
        if(bank_name)
        {
            ...
            notification('error','{{__('file.Please select mobile bank')}}');
        }
    });
